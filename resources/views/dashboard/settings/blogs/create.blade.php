...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.blogs')  .' - '. __('dashboard.add'))
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.settings.blogs.store') }}" method="post" enctype="multipart/form-data">
