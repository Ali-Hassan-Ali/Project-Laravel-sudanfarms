...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.about')  .' - '. __('dashboard.add'))
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.settings.settings.store') }}" method="post">
                        ...
                        @php
                            $names = ['about_me_ar','about_me_en'];
                            $item  = ['target_ar','target_en','the_message_ar','the_message_en','vision_ar','vision_en','rate_us_ar','rate_us_en'];
                        @endphp
