...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.categories'))
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('dashboard.categories') <small>{{ $categoreys->total() }}</small></h3>
